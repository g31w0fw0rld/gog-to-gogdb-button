...
// @version      1.5.5
// @description  Lookup buttons for GOG game pages. Before buying you still want the builds and the price history, where else it is cheaper and whether it runs at all — and GOG shows the game's name translated, so copying it into a search finds nothing. GOGDB, GG.deals and PCGamingWiki sit in GOG's own purchase column, aimed at the product id or at the English name. It reads the page and links out; nothing else. The rest is in the repository. 7 languages.
